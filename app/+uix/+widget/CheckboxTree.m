classdef CheckboxTree < uix.widget.Tree
    % CheckboxTree - Class definition for CheckboxTree
    %   The CheckboxTree object places a checkbox tree control within a
    %   figure or container.
    %
    % Syntax:
    %           tObj = uix.widget.CheckboxTree
    %           tObj = uix.widget.CheckboxTree('Property','Value',...)
    %
    %   The CheckboxTree contains all properties and methods of the
    %   <a href="matlab:doc uix.widget.Tree">uix.widget.Tree</a>, plus the following:
    %
    ...
    %
    %   %% Create tree nodes
    %   Node1 = uix.widget.CheckboxTreeNode('Name','Node_1','Parent',t.Root);
    %   Node1_1 = uix.widget.CheckboxTreeNode('Name','Node_1_1','Parent',Node1);
    %   Node1_2 = uix.widget.CheckboxTreeNode('Name','Node_1_2','Parent',Node1);
    %   Node2 = uix.widget.CheckboxTreeNode('Name','Node_2','Parent',t.Root);
    %
    %   %% Set an icon
    ...
    %   t.Enable = 'on';
    %
    % See also: uix.widget.Tree, uix.widget.TreeNode,
    ...
    methods
        function tObj = CheckboxTree(varargin)
            ...
            %
            % Syntax:
            %           tObj = uix.widget.CheckboxTree('p1',v1,...)
            %
            % Inputs:
            %           Property-value pairs
            %
            % Outputs:
            %           tObj - uix.widget.CheckboxTree object
            %
            % Examples:
            %           hFig = figure;
            ...
            tObj = tObj@uix.widget.Tree(varargin{:});
    ...
    methods
        ...
        function s = getJavaObjects(tObj)
            s = getJavaObjects@uix.widget.Tree(tObj);
    ...
    methods (Access = protected)
        ...
        function createTree(tObj)
            ...
            tObj.Root = uix.widget.CheckboxTreeNode('Name','Root','Tree',tObj);
        ...
        function createTreeCustomizations(tObj)
            ...
            createTreeCustomizations@uix.widget.Tree(tObj)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods (Access={?uix.widget.Tree, ?uix.widget.TreeNode})
        ...
        function setChecked(tObj,nObj,value)
            validateattributes(nObj,{'uix.widget.TreeNode'},{'vector'});
