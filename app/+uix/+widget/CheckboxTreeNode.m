classdef CheckboxTreeNode < uix.widget.TreeNode
    ...
    %   placed on a uix.widget.CheckboxTree control.
    %
    % Syntax:
    %   nObj = uix.widget.CheckboxTreeNode
    %   nObj = uix.widget.CheckboxTreeNode('Property','Value',...)
    %
    %   The CheckboxTree contains all properties and methods of the
    %   <a href="matlab:doc uix.widget.TreeNode">uix.widget.TreeNode</a>, plus the following:
    %
    ...
    %
    % Notes:
    %   - The CheckboxTreeNode may be also used on a uix.widget.Tree
    ...
    methods
        function nObj = CheckboxTreeNode(varargin)
            ...
            nObj = nObj@uix.widget.TreeNode(varargin{:});
    ...
    methods
        ...
        function nObjCopy = copy(nObj,NewParent)
            ...
            nObjCopy = copy@uix.widget.TreeNode(nObj,NewParent);
    ...
    methods
        ...
        function value = get.Checked(nObj)
            value = true(1,0);
            if ~isempty(nObj.Tree) && isa(nObj.Tree,'uix.widget.CheckboxTree')
